...
/* ==========================================================================
   ...
   ========================================================================== */
    ...
    $(document).ready(function()
    {
        $('.user-btn').hover(
            function(){ 
                $('.user-ul').removeClass("d-none"); //Add an active class to the anchor
                $('.user-ul').css("left","-80px");
            },
            function() {
                $('.user-ul').addClass("d-none"); //Remove an active class to the anchor
                $('.user-ul').removeAttr("style");
            }
        );
    });
